...
def get_flash_attn_version(
    ...
    try:
        ...
        if device_capability.major == 9 and is_fa_version_supported(3):
            ...
            fa_version = 3
        elif device_capability.major == 12 and is_fa_version_supported(3):
            # sm120 uses the vLLM FA3 kernel path in this environment.
            fa_version = 3
        ...
        if device_capability.major in (10, 11) and fa_version == 3:
            logger.warning_once(
